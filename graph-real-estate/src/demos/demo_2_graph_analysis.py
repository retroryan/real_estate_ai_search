...
class GraphRelationshipAnalysisDemo:
    ...
    def demo_1_similarity_networks(self):
        ...
        RETURN p1.listing_id as prop1, p1.listing_price as price1, n1.name as neighborhood1,
               p2.listing_id as prop2, p2.listing_price as price2, n2.name as neighborhood2,
        ...
        for i, cluster in enumerate(clusters, 1):
            ...
            print(f"   Property A: {cluster['prop1']} (${cluster['price1']:,.0f}) in {cluster['neighborhood1']}")
            print(f"   Property B: {cluster['prop2']} (${cluster['price2']:,.0f}) in {cluster['neighborhood2']}")
    ...
    def demo_2_feature_networks(self):
        ...
        for combo in unique_combos:
            print(f"   {combo['property_id']}: ${combo['price']:,.0f}")
    ...
    def demo_5_investment_patterns(self):
        ...
        for hub in hubs:
            ...
            print(f"   ${hub['price']:,.0f} (${hub['price_per_sqft']:.0f}/sqft)")
            print(f"   {hub['neighborhood']}, {hub['city']}")
    ...
    def _analyze_feature_category_bridges(self):
        ...
        for bridge in bridges:
            print(f"   {bridge['property_id']}: ${bridge['price']:,.0f}")
