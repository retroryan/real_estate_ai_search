...
class PipelineOrchestrator:
    ...
    def run_embeddings(
        ...
        provider_config = self.settings.embedding
        provider = create_provider(
            provider_type=provider_type,
            api_key=api_key or self.settings.get_api_key(),
            model_name=self.settings.get_model_name(),
            base_url=provider_config.ollama_base_url if provider_type == "ollama" else None
        )
